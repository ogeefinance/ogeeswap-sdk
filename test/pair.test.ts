...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0x9362Bbef4B8313A8Aa9f0c9808B80577Aa26B73B', 18, 'USDC-HECO', 'Heco-Peg USDCHECO Token')
  const DAI = new Token(ChainId.MAINNET, '0x3D760a45D0887DFD89A2F5385a236B29Cb46ED2a', 18, 'DAI-HECO', 'DAI Stablecoin')

  describe('constructor', () => {
    it('cannot be used for tokens on different chains', () => {
      expect(() => new Pair(new TokenAmount(USDC, '100'), new TokenAmount(WETH[ChainId.HECOTESTNET], '100'))).toThrow(
        'CHAIN_IDS'
      )
    })
  })
